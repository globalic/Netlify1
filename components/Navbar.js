...
export const Navbar = ({ currentPage }) => {
  ...
  return (
    <nav className="sticky inset-0 z-20 lg:flex items-center justify-between bg-white dark:bg-gray-900 py-4 lg:px-8 shadow border-solid border-t-2 border-blue-700">
      <div className="flex justify-between w-full px-8 border-solid border-b-2 border-gray-300 pb-5 lg:pb-0 lg:px-0 lg:w-auto lg:border-b-0">
