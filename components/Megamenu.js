                ...
                <div class="bg-white rounded w-full relative z-10 py-1">
                  <ul class="list-reset">
                    <li class="relative">
                      ...
                      >
                        {" "}
                        <span class="flex-1">Dashboard 1</span>{" "}
                      </a>
                    </li>
                    <li class="relative">
                      <a
                      ...
                      >
                        {" "}
                        <span class="flex-1">Dashboard 2</span>{" "}
                      </a>
                    </li>
                  </ul>
                </div>
                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                          <ul class="list-reset">
                            ...
                            <li>
                              ...
                              >
                                {" "}
                                <span class="flex-1">Drag n Drop</span>{" "}
                              </a>
                            </li>
                            <li>
                              <a
                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                          <ul class="list-reset">
                            <li>
                              ...
                              >
                                {" "}
                                <span class="flex-1">Form Elements</span>{" "}
                              </a>
                            </li>
                            <li>
                              <a
                              ...
                              >
                                {" "}
                                <span class="flex-1">Advanced Forms</span>{" "}
                              </a>
                            </li>
                            <li>
                              <a
                              ...
                              >
                                {" "}
                                <span class="flex-1">Basic Tables</span>{" "}
                              </a>
                            </li>
                            <li>
                              <a
                              ...
                              >
                                {" "}
                                <span class="flex-1">Data Tables</span>{" "}
                              </a>
                            </li>
                          </ul>
                        </div>
                ...
                <div class="bg-white rounded w-full relative z-10 py-1">
                  <ul class="list-reset">
                    <li class="relative">
                      ...
                      >
                        {" "}
                        <span class="flex-1">User Profile</span>{" "}
                      </a>
                    </li>
                    <li class="relative">
                      <a
                        ...
                        <div class="bg-white rounded w-full relative z-10 py-1">
                          <ul class="list-reset">
                            ...
                            <li>
                              ...
                              >
                                {" "}
                                <span class="flex-1">Lock Screen</span>{" "}
                              </a>
                            </li>
                          </ul>
                        </div>
                ...
                <div class="bg-white rounded w-full relative z-10 py-1">
                  <ul class="list-reset">
                    <li class="relative">
                      ...
                      >
                        {" "}
                        <span class="flex-1">Calender</span>{" "}
                      </a>
                    </li>
                    <li class="relative">
                      <a
