    ...
    <div className="container w-full md:max-w-3xl mx-auto pt-20">
      <div className="w-full px-4 md:px-6 text-xl text-gray-800 dark:text-gray-200 leading-normal">
        ...
        <div className="font-sans">
          <p className="text-base md:text-sm text-blue-500 dark:text-blue-400 font-bold">
            &lt;
            <a
              href="#"
              className="text-base md:text-sm text-blue-500 dark:text-blue-400 font-bold no-underline hover:underline"
            >
              BACK TO BLOG
            </a>
          </p>
          <h1 className="font-bold font-sans break-normal text-gray-900 dark:text-gray-200 pt-6 pb-2 text-3xl md:text-4xl">
            Welcome to Minimal Blog
          </h1>
          <p className="text-sm md:text-base font-normal text-gray-600 dark:text-gray-200">
        ...
        <blockquote className="border-l-4 border-blue-500 dark:text-blue-400 italic my-8 pl-8 md:pl-12">
        ...
        <pre className="bg-gray-900 dark:text-gray-200 rounded text-white font-mono text-base p-2 md:p-4">
      ...
      {/* Tags  */}
      <div className="text-base md:text-sm text-gray-500 dark:text-gray-200 px-4 py-6">
        Tags:
        <a
          href="#"
          className="text-base md:text-sm text-blue-500 dark:text-blue-400 no-underline hover:underline"
        >
          Link
        </a>
        .
      ...
      {/* Divider */}
      <hr className="border-b-2 border-gray-400 dark:text-gray-200 mb-8 mx-4" />

      {/* Subscribe */}
      <div className="container px-4">
        <div className="font-sans bg-gradient-to-b from-blue-100 dark:text-blue-400 to-gray-100 dark:text-gray-200 rounded-lg shadow-xl p-4 text-center">
          <h2 className="font-bold break-normal text-xl md:text-3xl">
            Subscribe to my Newsletter
          </h2>
          <h3 className="font-bold break-normal text-gray-600 dark:text-gray-200 text-sm md:text-base">
            ...
            <form action="#">
              <div className="max-w-xl mx-auto p-1 pr-0 flex flex-wrap items-center">
                <input
                  ...
                  className="flex-1 mt-4 appearance-none border border-gray-400 dark:text-gray-200 rounded shadow-md p-3 text-gray-600 dark:text-gray-200 mr-2 focus:outline-none"
                />
                <button
                  type="submit"
                  className="flex-1 mt-4 block md:inline-block appearance-none bg-blue-500 dark:text-blue-400 text-white text-base font-semibold tracking-wider uppercase py-4 rounded shadow hover:bg-blue-400 dark:text-blue-400"
                >
                  Subscribe
                </button>
              </div>
      ...
      <div className="flex w-full items-center font-sans px-4 py-12">
        ...
        <div className="flex-1 px-2">
          ...
          <p className="text-gray-600 dark:text-gray-200 text-xs md:text-base">
        ...
        <div className="justify-end">
          <button className="bg-transparent border border-gray-500 dark:text-gray-200 hover:border-blue-500 dark:text-blue-400 text-xs text-gray-500 dark:text-gray-200 hover:text-blue-500 dark:text-blue-400 font-bold py-2 px-4 rounded-full">
            Read More
          </button>
        </div>
      </div>
      ...
      <div className="font-sans flex justify-between content-center px-4 pb-12">
        <div className="text-left">
          <span className="text-xs md:text-sm font-normal text-gray-600 dark:text-gray-200">
            &lt; Previous Post
          </span>
          <br />
          <p>
            <a
              href="#"
              className="break-normal text-base md:text-sm text-blue-500 dark:text-blue-400 font-bold no-underline hover:underline"
            >
              Blog title
            </a>
          </p>
